...
flags = tf.app.flags
## pfguard === 
flags.DEFINE_boolean("resample", False, "True for SIR, False for random sampling [False]")
flags.DEFINE_boolean("binary", False, "True for binary class, False for multiclass [False]")
flags.DEFINE_float("train_size", np.inf, "The size of train images [np.inf]")
flags.DEFINE_string("data_dir", "../dataset", "Root directory of dataset [data]")
...
def main(_):
    ...
    with tf.Session(config=run_config) as sess:
        ...
        data = dcgan.gen_data(n_batch, label=None)
        # ===
