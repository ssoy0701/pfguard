...
def parse_arguments():
    ...
    ## ssoy =====================================================
    parser.add_argument('--bias_level', type=int, default=1, help='for multiclass')
    parser.add_argument('--multiclass', action='store_true', default=False)
    parser.add_argument("--target_gpu", "-gpu", type=int, default=0)
    parser.add_argument("--datapath", "-dpath", type=str)
